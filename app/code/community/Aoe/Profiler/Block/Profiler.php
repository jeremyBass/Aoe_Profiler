	...
	protected function _toHtml() {
		...
		if (!Varien_Profiler::isEnabled()) {
			if (Mage::getStoreConfig('dev/debug/showDisabledMessage')) {
				...
				$output .= '<div id="profiler"><a href="'.$url.'" id="hide_profiler" class="hidden_profiler"><i class="fa-eye"></i>Show</a><div id="prowrap">
		...
		$output .= '<div id="profiler" class="active"><a href="#" id="hide_profiler"><i class="fa-eye-slash"></i>Hide</a><div id="prowrap"><h1>Profiler</h1>';
